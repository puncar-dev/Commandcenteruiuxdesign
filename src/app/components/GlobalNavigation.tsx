...
export default function GlobalNavigation({ activeItem = "Command Center", onNavigate, collapsed = false }: GlobalNavigationProps) {
  ...
  return (
    <div className={cn(
        "h-full bg-sidebar border-r border-sidebar-border flex flex-col shrink-0 text-sidebar-foreground font-sans transition-all duration-300 ease-in-out z-50",
        collapsed ? "w-20" : "w-64"
    )}>
      {/* Logo Area */}
